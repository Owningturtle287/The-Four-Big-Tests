...
import {DARK_ITEMS as LEGACY_DARK_ITEMS} from './data/dark-v1.js';
import {IQ_VERSION} from './iq.js';
import {POLITICAL_ITEMS,POLITICAL_FACETS} from './data/politics.js';
export const VERSION = '2.0.0';
export const LEGACY_DARK_VERSION = 'sd4-paulhus-2020';
export const DARK_VERSION = 'dark-behavior-2.0';
export function assessmentItems(type,version){return type==='dark'&&version===LEGACY_DARK_VERSION?LEGACY_DARK_ITEMS:DEFINITIONS[type].items;}
...
export const DARK_DOMAINS = {
  M:{name:'Machiavellianism',short:'Strategic manipulation',description:'These questions concern concealment, insincere influence, and using relationships for advantage. Planning by itself does not establish manipulation.'},
  ...
  S:{name:'Sadism',short:'Supplementary fourth trait',description:'The additional scale concerns reactions to other people’s real distress and intentionally hurtful behavior. No single answer establishes a trait or predicts harmful conduct.'},
};
export const DEFINITIONS = {
  ...
  iq:{name:'IQ',number:'02',subtitle:'Reason through unfamiliar problems.',questions:50,time:'60 min',instrument:'Original reasoning battery · v2',color:'#126e71',intro:'Five harder sections of patterns, numbers, spatial puzzles, logic, and quantitative reasoning. Each has ten questions, six choices per question, and a 12-minute timer.',instruction:'Work independently. Avoid calculators, search, and outside help. Scratch paper is fine.',version:IQ_VERSION,note:'Timed results include a provisional IQ-style number and raw accuracy. The number uses assumed anchors, not population norms, so it is not a standardized IQ or percentile.'},
  ...
  dark:{name:'Dark triad',number:'04',subtitle:'Reflect on the harder edges of personality.',questions:28,time:'5–7 min',instrument:'Behavioral dark-trait profile · v2',color:'#795196',intro:'Rate specific behaviors and attitudes relating to Machiavellianism, narcissism, and psychopathy-related traits. Sadism is shown separately. These are original adaptations, not the validated SD4 wording.',instruction:'Think about your actual behavior and reactions, especially over the past year. Consider how often a statement is true of you; agreeing that it could be true of people in general is not the same as having done it yourself.',labels:['Very unlike me','Mostly unlike me','Sometimes like me','Mostly like me','Very like me'],items:DARK_ITEMS,version:DARK_VERSION,note:'Concrete self-report statements; changed wording has not been psychometrically validated. Results are not a diagnosis or a judgment of character. Intended for adults.'},
};
...
export function scoreTraits(type,answers,version=DEFINITIONS[type].version) {
  const items=assessmentItems(type,version),domains={},facets={};
